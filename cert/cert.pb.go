...
type RawNebulaEncryptedData struct {
	...
	EncryptionMetadata *RawNebulaEncryptedDataMetadata `protobuf:"bytes,1,opt,name=EncryptionMetadata,proto3" json:"EncryptionMetadata,omitempty"`
...
func (x *RawNebulaEncryptedData) GetEncryptionMetadata() *RawNebulaEncryptedDataMetadata {
	if x != nil {
...
type RawNebulaEncryptedDataMetadata struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EncryptionAlgorithm     string `protobuf:"bytes,1,opt,name=EncryptionAlgorithm,proto3" json:"EncryptionAlgorithm,omitempty"`
	KeyDerivationParameters string `protobuf:"bytes,2,opt,name=KeyDerivationParameters,proto3" json:"KeyDerivationParameters,omitempty"`
}

func (x *RawNebulaEncryptedDataMetadata) Reset() {
	*x = RawNebulaEncryptedDataMetadata{}
	if protoimpl.UnsafeEnabled {
...
func (x *RawNebulaEncryptedDataMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawNebulaEncryptedDataMetadata) ProtoMessage() {}

func (x *RawNebulaEncryptedDataMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_cert_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawNebulaEncryptedDataMetadata.ProtoReflect.Descriptor instead.
func (*RawNebulaEncryptedDataMetadata) Descriptor() ([]byte, []int) {
	return file_cert_proto_rawDescGZIP(), []int{3}
}

func (x *RawNebulaEncryptedDataMetadata) GetEncryptionAlgorithm() string {
	if x != nil {
...
func (x *RawNebulaEncryptedDataMetadata) GetKeyDerivationParameters() string {
	if x != nil {
		return x.KeyDerivationParameters
	}
	return ""
}
...
var file_cert_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x8e, 0x01, 0x0a, 0x16, 0x52, 0x61, 0x77, 0x4e, 0x65, 0x62, 0x75, 0x6c, 0x61, 0x45,
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x12, 0x54, 0x0a, 0x12,
	0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x2e,
	0x52, 0x61, 0x77, 0x4e, 0x65, 0x62, 0x75, 0x6c, 0x61, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x12,
	0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x78, 0x74, 0x22, 0x8c, 0x01, 0x0a, 0x1e, 0x52, 0x61, 0x77, 0x4e, 0x65, 0x62, 0x75, 0x6c, 0x61,
	0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x4d, 0x65, 0x74,
	...
	0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x12, 0x38, 0x0a, 0x17, 0x4b, 0x65, 0x79, 0x44, 0x65,
	0x72, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x17, 0x4b, 0x65, 0x79, 0x44, 0x65, 0x72,
...
var file_cert_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_cert_proto_goTypes = []interface{}{
	...
	(*RawNebulaEncryptedDataMetadata)(nil), // 3: cert.RawNebulaEncryptedDataMetadata
}
var file_cert_proto_depIdxs = []int32{
	1, // 0: cert.RawNebulaCertificate.Details:type_name -> cert.RawNebulaCertificateDetails
	3, // 1: cert.RawNebulaEncryptedData.EncryptionMetadata:type_name -> cert.RawNebulaEncryptedDataMetadata
...
func file_cert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cert_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RawNebulaEncryptedDataMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
