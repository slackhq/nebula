...
type NebulaMetaDetails struct {
	...
	// DEPRECATED legacy PQ gossip (raw hash + ports). Emitted AND read for
	// one release for interop with pre-opaque-blob peers. Superseded by
	// PqPskIdentity (field 11). Remove after the fleet has upgraded.
	RosenpassPubkeySha256 []byte `protobuf:"bytes,8,opt,name=RosenpassPubkeySha256,proto3" json:"RosenpassPubkeySha256,omitempty"` // Deprecated: Do not use.
	RosenpassPort         uint32 `protobuf:"varint,9,opt,name=RosenpassPort,proto3" json:"RosenpassPort,omitempty"`                // Deprecated: Do not use.
	DiscoveryPort         uint32 `protobuf:"varint,10,opt,name=DiscoveryPort,proto3" json:"DiscoveryPort,omitempty"`               // Deprecated: Do not use.
	// Canonical opaque PQ-PSK provider identity blob. Provider-defined bytes
	// (see pq.IdentityCodec); core ferries them verbatim. Preferred over the
	// legacy 8/9/10 fields when present.
	PqPskIdentity []byte `protobuf:"bytes,11,opt,name=PqPskIdentity,proto3" json:"PqPskIdentity,omitempty"`
}
...
// Deprecated: Do not use.
func (m *NebulaMetaDetails) GetRosenpassPubkeySha256() []byte {
	if m != nil {
		return m.RosenpassPubkeySha256
	}
	return nil
}

// Deprecated: Do not use.
func (m *NebulaMetaDetails) GetRosenpassPort() uint32 {
	if m != nil {
		return m.RosenpassPort
	}
	return 0
}

// Deprecated: Do not use.
func (m *NebulaMetaDetails) GetDiscoveryPort() uint32 {
	if m != nil {
...
func (m *NebulaMetaDetails) GetPqPskIdentity() []byte {
	if m != nil {
		return m.PqPskIdentity
	}
	return nil
}
...
var fileDescriptor_2d65afa7693df5ef = []byte{
	...
	,
}
...
func (m *NebulaMetaDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PqPskIdentity) > 0 {
		i -= len(m.PqPskIdentity)
		copy(dAtA[i:], m.PqPskIdentity)
		i = encodeVarintNebula(dAtA, i, uint64(len(m.PqPskIdentity)))
		i--
		dAtA[i] = 0x5a
	}
	if m.DiscoveryPort != 0 {
		i = encodeVarintNebula(dAtA, i, uint64(m.DiscoveryPort))
		i--
		dAtA[i] = 0x50
	}
	if m.RosenpassPort != 0 {
		i = encodeVarintNebula(dAtA, i, uint64(m.RosenpassPort))
		i--
		dAtA[i] = 0x48
	}
	if len(m.RosenpassPubkeySha256) > 0 {
		i -= len(m.RosenpassPubkeySha256)
		copy(dAtA[i:], m.RosenpassPubkeySha256)
		i = encodeVarintNebula(dAtA, i, uint64(len(m.RosenpassPubkeySha256)))
		i--
		dAtA[i] = 0x42
	}
...
func (m *NebulaMetaDetails) Size() (n int) {
	...
	l = len(m.RosenpassPubkeySha256)
	if l > 0 {
		n += 1 + l + sovNebula(uint64(l))
	}
	if m.RosenpassPort != 0 {
		n += 1 + sovNebula(uint64(m.RosenpassPort))
	}
	if m.DiscoveryPort != 0 {
		n += 1 + sovNebula(uint64(m.DiscoveryPort))
	}
	l = len(m.PqPskIdentity)
	if l > 0 {
		n += 1 + l + sovNebula(uint64(l))
	}
	return n
...
func (m *NebulaMetaDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RosenpassPubkeySha256", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RosenpassPubkeySha256 = append(m.RosenpassPubkeySha256[:0], dAtA[iNdEx:postIndex]...)
			if m.RosenpassPubkeySha256 == nil {
				m.RosenpassPubkeySha256 = []byte{}
			}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RosenpassPort", wireType)
			}
			m.RosenpassPort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RosenpassPort |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DiscoveryPort", wireType)
			}
			m.DiscoveryPort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DiscoveryPort |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PqPskIdentity", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PqPskIdentity = append(m.PqPskIdentity[:0], dAtA[iNdEx:postIndex]...)
			if m.PqPskIdentity == nil {
				m.PqPskIdentity = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
