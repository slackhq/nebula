...
package nebula // import "github.com/slackhq/nebula"
...
func (NebulaMeta_MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{0, 0}
}
...
func (NebulaPing_MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{4, 0}
}
...
func (NebulaControl_MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{7, 0}
}
...
type NebulaMeta struct {
	...
	Details              *NebulaMetaDetails     `protobuf:"bytes,2,opt,name=Details" json:"Details,omitempty"`
...
func (*NebulaMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{0}
}
...
func (dst *NebulaMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaMeta.Merge(dst, src)
}
...
type NebulaMetaDetails struct {
	...
	Ip4AndPorts          []*Ip4AndPort `protobuf:"bytes,2,rep,name=Ip4AndPorts" json:"Ip4AndPorts,omitempty"`
	Ip6AndPorts          []*Ip6AndPort `protobuf:"bytes,4,rep,name=Ip6AndPorts" json:"Ip6AndPorts,omitempty"`
	RelayVpnIp           []uint32      `protobuf:"varint,5,rep,packed,name=RelayVpnIp" json:"RelayVpnIp,omitempty"`
...
func (*NebulaMetaDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{1}
}
...
func (dst *NebulaMetaDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaMetaDetails.Merge(dst, src)
}
...
func (*Ip4AndPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{2}
}
...
func (dst *Ip4AndPort) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Ip4AndPort.Merge(dst, src)
}
...
func (*Ip6AndPort) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{3}
}
...
func (dst *Ip6AndPort) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Ip6AndPort.Merge(dst, src)
}
...
func (*NebulaPing) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{4}
}
...
func (dst *NebulaPing) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaPing.Merge(dst, src)
}
...
type NebulaHandshake struct {
	Details              *NebulaHandshakeDetails `protobuf:"bytes,1,opt,name=Details" json:"Details,omitempty"`
...
func (*NebulaHandshake) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{5}
}
...
func (dst *NebulaHandshake) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaHandshake.Merge(dst, src)
}
...
func (*NebulaHandshakeDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{6}
}
...
func (dst *NebulaHandshakeDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaHandshakeDetails.Merge(dst, src)
}
...
func (*NebulaControl) Descriptor() ([]byte, []int) {
	return fileDescriptor_nebula_f6b42a6e99b593b3, []int{7}
}
...
func (dst *NebulaControl) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NebulaControl.Merge(dst, src)
}
...
func (m *NebulaMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Details != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintNebula(dAtA, i, uint64(m.Details.Size()))
...
func (m *NebulaMetaDetails) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Ip4AndPorts) > 0 {
		for _, msg := range m.Ip4AndPorts {
			dAtA[i] = 0x12
			i++
			i = encodeVarintNebula(dAtA, i, uint64(msg.Size()))
	...
	for iNdEx < l {
		...
		case 3:
			for {
				...
				next, err := skipNebula(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
func init() { proto.RegisterFile("nebula.proto", fileDescriptor_nebula_f6b42a6e99b593b3) }

var fileDescriptor_nebula_f6b42a6e99b593b3 = []byte{
	// 688 bytes of a gzipped FileDescriptorProto
	,
}
