...
func NewRemoteList() *RemoteList {
	return &RemoteList{
		...
		cache: make(map[netaddr.IP]*cache),
	}
}
...
func (r *RemoteList) LearnRemote(ownerVpnIp netaddr.IP, addr *udpAddr) {
	r.Lock()
	defer r.Unlock()
...
func (r *RemoteList) unlockedSetLearnedV4(ownerVpnIp netaddr.IP, to *Ip4AndPort) {
	r.shouldRebuild = true
...
func (r *RemoteList) unlockedSetV4(ownerVpnIp netaddr.IP, to []*Ip4AndPort, check checkFuncV4) {
	r.shouldRebuild = true
...
func (r *RemoteList) unlockedPrependV4(ownerVpnIp netaddr.IP, to *Ip4AndPort) {
	r.shouldRebuild = true
	c := r.unlockedGetOrMakeV4(ownerVpnIp)
...
// deduplicated address list as dirty
func (r *RemoteList) unlockedSetLearnedV6(ownerVpnIp netaddr.IP, to *Ip6AndPort) {
	r.shouldRebuild = true
...
// and marks the deduplicated address list as dirty
func (r *RemoteList) unlockedSetV6(ownerVpnIp netaddr.IP, to []*Ip6AndPort, check checkFuncV6) {
	r.shouldRebuild = true
...
// This is only useful for establishing static hosts
func (r *RemoteList) unlockedPrependV6(ownerVpnIp netaddr.IP, to *Ip6AndPort) {
	r.shouldRebuild = true
	c := r.unlockedGetOrMakeV6(ownerVpnIp)
...
func (r *RemoteList) unlockedGetOrMakeV4(ownerVpnIp netaddr.IP) *cacheV4 {
...
// The caller must dirty the learned address cache if required
func (r *RemoteList) unlockedGetOrMakeV6(ownerVpnIp netaddr.IP) *cacheV6 {
	am := r.cache[ownerVpnIp]
	if am == nil {
		am = &cache{}
		r.cache[ownerVpnIp] = am
